...
interface TipoMaquinaDetailModalProps {
  isOpen: boolean;
  onClose: () => void;
  tipoMaquina: string;
  vendas: Venda[];
...
const TipoMaquinaDetailModal: React.FC<TipoMaquinaDetailModalProps> = ({
  isOpen,
  onClose,
  tipoMaquina,
  vendas
...
export default TipoMaquinaDetailModal;